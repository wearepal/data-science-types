...
class ndarray(Generic[_DType]):
    ...
    @overload
    def astype(self, dtype: Type[_DType2], copy: bool = ...) -> ndarray[_DType2]: ...
    @overload
...
# np.array: then check if it is a list of ints (this is more specific than a check for floats)
@overload
...
def max(
    a: ndarray[_DType], axis: Optional[_AxesType] = ..., keepdims: bool = ...
) -> ndarray[_DType]: ...
@overload
