...
_DType = TypeVar('_DType', bool_, float32, float64, int16, int32, int64, str_)
_DType2 = TypeVar('_DType2', bool_, float32, float64, int16, int32, int64, str_)
...
_Int = TypeVar('_Int', int16, int32, int64)
...
class ndarray(Generic[_DType]):
    ...
    @overload
    def __getitem__(self, key: Union[int, Tuple[int, ...], str]) -> _DType: ...
    @overload
    def __getitem__(
        self,
        key: Union[
    ...
    @overload
    def __truediv__(self: ndarray[_Float], value: object) -> ndarray[_Float]: ...
    @overload
...
#
@overload
def array(object: Union[_NestedList[Any], Iterable[ndarray], ndarray], dtype: Type[_DType] = ...) -> ndarray[_DType]: ...
@overload
def array(object: _NestedList[_Float]) -> ndarray[_Float]: ...
@overload
def array(object: _NestedList[_FloatObj],) -> ndarray[float64]: ...
@overload
def array(object: _NestedList[_Int]) -> ndarray[_Int]: ...
@overload
def array(object: _NestedList[_IntObj]) -> ndarray[int64]: ...
@overload
def array(object: ndarray[_DType]) -> ndarray[_DType]: ...
@overload
...
@overload
def argmax(a: List[Any], axis: _AxesType = ..., out: Optional[ndarray[_DType]] = ...) -> int64: ...
@overload
def argmax(a: ndarray[_DType], axis: _AxesType = ..., out: Optional[ndarray[_DType]] = ...) -> ndarray[int64]: ...
...
def in1d(ar1: ndarray[_DType], ar2: ndarray[_DType], assume_unique: bool = ..., inverse: bool = ...) -> ndarray[bool_]: ...
def isin(element: ndarray[_DType], test_element: [_DType]) -> ndarray[_DType]: ...
@overload
def isnan(x: float64) -> bool: ...
@overload
def isnan(x: ndarray[_DType]) -> ndarray[bool]: ...
@overload
...
def nan_to_num(x: ndarray[_DType], copy: bool = ..., nan: _AnyNum = ..., posinf: _AnyNum = ..., neginf: _AnyNum = ...) -> ndarray[_DType]: ...
...
@overload
def prod(a: ndarray[_DType]) -> _DType: ...
@overload
def prod(a: ndarray[_DType], axis: Optional[_AxesType], keepdims: bool = ...) -> ndarray[_DType]: ...
...
def setdiff1d(ar1: ndarray[_DType], ar2: ndarray[_DType], assume_unique: bool = ...) -> ndarray[_DType]: ...
...
@overload
def unique(a: ndarray[_DType], return_counts: bool = ..., axis: Optional[int] = ...) -> Tuple[ndarray[_DType], ndarray[_DType]]: ...
@overload
def unique(a: ndarray[_DType], return_inverse: bool = ..., axis: Optional[int] = ...) -> Tuple[ndarray[_DType], ndarray[_DType]]: ...
