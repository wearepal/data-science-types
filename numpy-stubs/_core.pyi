...
class ndarray(Generic[_DType]):
    ...
    @overload
    def tolist(self: Union[ndarray[int16], ndarray[int32], ndarray[int64]]) -> List[int]: ...
    @overload
    def tolist(self: ndarray) -> List[object]: ...
    ...
    def __array__(self, dtype: Optional[Type[_Dtype]] = ...) -> ndarray[_DType]: ...
...
@overload
def divide(x1: ndarray[float32], x2: ndarray[float32]) -> ndarray[float32]: ...
@overload
