...
_Num = TypeVar('_Num', bound=_dtype)
_Num2 = TypeVar('_Num2', bound=_dtype)
...
@overload
def ones_like(a: ndarray[_Num], dtype: Type[_Num2], subok: bool = ...) -> ndarray[_Num2]: ...
...
@overload
def zeros_like(a: ndarray[_Num], dtype: Type[_Num2], subok: bool = ...) -> ndarray[_Num2]: ...

#
# Array transformation routines
#
def astype(a: ndarray[_Num], dtype: Type[_Num2]) -> ndarray[_Num2]: ...
...
# Saving methods
#
def savez_compressed(file: Path, **kwargs: ndarray) -> None: ...
