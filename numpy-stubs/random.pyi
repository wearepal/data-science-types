...
from ._core import _ShapeType, ndarray, float64, int64, _Float, _Num, _DType, _Int, _DTypeObj, _FloatObj, _IntObj
...
@overload
def choice(a: List[_T], p: Union[List[_FloatObj], ndarray[_Float]] = ..., replace: bool = ...) -> _T: ...
# @overload
# def choice(a: List[_T], size: _IntObj, p: Union[List[_FloatObj], ndarray[_Float]] = ..., replace: bool = ...) -> ndarray[_T]: ...
@overload
def choice(a: range, size: _IntObj, replace: bool = ..., p: Union[List[_FloatObj], ndarray[_Float]] = ...) -> ndarray[int64]: ...
@overload
def choice(a: range, *, replace: bool = ..., p: Union[List[_FloatObj], ndarray[_Float]] = ...) -> int64: ...
@overload
def choice(a: ndarray[_DType], size: _IntObj, replace: bool = ..., p: Union[List[_FloatObj], ndarray[_Float]] = ...) -> ndarray[_DType]: ...
@overload
def choice(a: ndarray[_DType], *, replace: bool = ..., p: Union[List[_FloatObj], ndarray[_Float]] = ...) -> _DType: ...
