...
from . import _DType, _Float, _FloatObj, _Int, _IntObj, _ShapeType, float64, int64, ndarray, _ArrayLike
...
def multinomial(n : int, pvals : _ArrayLike[float] = ..., size: Union[int, Tuple[int, ...]] = ...) -> ndarray[_Int]: ...
