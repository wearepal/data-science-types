...
def diff(
    a: ndarray[_DType], n: _Int = ..., axis: _AxesType = ..., prepend: Optional[ndarray[_DType]] = ..., append: Optional[ndarray[_DType]] = ...
) -> ndarray[_DType]: ...
