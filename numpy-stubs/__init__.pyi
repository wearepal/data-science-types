...
def array_split(ary: ndarray[_DType], indices_or_sections: Union[int, List[int]], axis: int = ...) -> List[ndarray[_DType]]: ...
...
def split(ary: ndarray[_DType], indices_or_sections: Union[int, List[int]], axis: int = ...) -> List[ndarray[_DType]]: ...
