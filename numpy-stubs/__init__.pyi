...
def bincount(x : _ArrayLike[_DType], weights: _ArrayLike = ..., minlength: int = ... ) -> ndarray[_DType]: ...
@overload
...
@overload
def percentile(
    a: ndarray[_DType], q: _FloatObj, interpolation: _InterpolationType = ..., axis: _AxesType = ...
) -> _DType: ...
@overload
def percentile(
    a: ndarray[_DType],
