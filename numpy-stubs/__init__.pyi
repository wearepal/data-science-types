...
@overload
def atleast_2d(ary: Union[ndarray, Sequence[ndarray]]) -> ndarray: ...
@overload
def atleast_2d(*ary: ndarray) -> List[ndarray]: ...
@overload
...
@overload
def percentile(a: ndarray[_DType], q: float, interpolation: _InterpolationType = ..., axis: _AxesType = ...) -> _DType: ...
@overload
def percentile(a: ndarray[_DType], q: _ArrayLike, interpolation: _InterpolationType = ..., axis: _AxesType = ...) -> ndarray[_DType]: ...
...
def round(a: ndarray[_DType], decimals: _IntObj = ...) -> ndarray[_DType]: ...
def save(
