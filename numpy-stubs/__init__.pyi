...
_DType = TypeVar("_DType", bool_, float32, float64, int8, int16, int32, int64, str_, uint8, uint16, uint32, uint64, covariant=True)
...
@overload
def nanstd(a: Union[ndarray[_Int], ndarray[bool_]]) -> float64: ...
@overload
