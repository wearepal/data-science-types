...
@overload
def isna(obj: Union[None, float, str]) -> bool: ...
@overload
...
@overload
def notna(obj: Union[None, float, str]) -> bool: ...
@overload
def notna(obj: DataFrame) -> DataFrame: ...
@overload
def notna(obj: Series) -> Series[bool]: ...
@overload
def notna(obj: Union[Index, _np.ndarray]) -> _np.ndarray[_np.bool_]: ...
@overload
def notnull(obj: Union[None, float, str]) -> bool: ...
@overload
def notnull(obj: DataFrame) -> DataFrame: ...
@overload
def notnull(obj: Series) -> Series[bool]: ...
@overload
def notnull(obj: Union[Index, _np.ndarray]) -> _np.ndarray[_np.bool_]: ...
def read_parquet(
