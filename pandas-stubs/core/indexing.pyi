...
class _LocIndexerFrame:
    ...
    @overload
    def __getitem__(self, idx: Hashable) -> Series: ...
    @overload
    def __getitem__(self, idx: List[Hashable]) -> DataFrame: ...
    @overload
    def __getitem__(
        self, idx: Tuple[Union[_MaskType, List[str]], Union[_MaskType, List[str]]],
    ) -> DataFrame: ...
    @overload
    def __getitem__(self, idx: Tuple[Hashable, Hashable]) -> float: ...
    # set item
    @overload
    def __setitem__(self, idx: _MaskType, value: Union[float, _np.ndarray, DataFrame]) -> None: ...
    @overload
    def __setitem__(self, idx: Hashable, value: Union[float, Series, _np.ndarray]) -> None: ...
    @overload
    def __setitem__(
        self, idx: List[Hashable], value: Union[float, _np.ndarray, DataFrame]
    ) -> None: ...
    @overload
...
class _AtIndexerSeries(Generic[_DType]):
    # get item
    def __getitem__(self, idx: Hashable) -> _DType: ...
    # set item
    def __setitem__(self, idx: Hashable, value: _DType) -> None: ...
