...
class Series(Generic[_DType]):
    ...
    @overload
    def duplicated(self, keep: Literal["first"] = ...) -> Series[_DType]: ...
    @overload
    def duplicated(self, keep: Literal["last"] = ...) -> Series[_DType]: ...
    @overload
    def duplicated(self, keep: Literal[False] = ...) -> Series[_DType]: ...
    @overload
    def fillna(
        self,
