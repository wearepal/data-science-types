...
class Series(Generic[_DType]):
    def __init__(
        self,
        data: Optional[
            Union[_ListLike[_DType], Series[_DType],
                  Dict[int, _DType], Dict[str, _DType]]
        ],
    ...
    @overload
    def __getitem__(
        self, idx: Union[List[_str], Index[int], Series, slice]) -> Series: ...
    ...
    def count(self) -> int: ...
    def fillna(self, value: Union[_DType, Dict,
                                  Series, DataFrame]) -> Series: ...

    def isna(self) -> Series[bool]: ...
    def isnull(self) -> Series[bool]: ...
    def isin(self, values: Union[Set, List,
    ...
    @overload
    def sort_values(
        self, inplace: Literal[True], ascending: bool = ...) -> None: ...
    ...
    def std(self) -> float: ...
    def sum(self) -> float: ...
    def to_csv(self, filename: Union[Path, _str],
               index: bool = ...) -> None: ...
