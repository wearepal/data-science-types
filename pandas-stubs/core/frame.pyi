...
class DataFrame:
    ...
    def fillna(self, value: Union[Scalar, Dict, Series, DataFrame], method: str = None, axis: Union[str, int] = None, inplace: bool = False, limit: int = None, downcast: Dict = None) -> Union[DataFrame, None]: ...
    @overload
