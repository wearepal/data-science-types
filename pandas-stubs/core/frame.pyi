...
class DataFrame:
    ...
    @overload
    def fillna(self, value: Union[Scalar, Dict, Series, DataFrame], inplace: Literal[True], method: str = ..., axis: Union[str, int] = ..., limit: int = ..., downcast: Dict = ...) -> None: ...
    @overload
    def fillna(self, value: Union[Scalar, Dict, Series, DataFrame], inplace: Literal[False] = ..., method: str = ..., axis: Union[str, int] = ..., limit: int = ..., downcast: Dict = ...) -> DataFrame: ...
    @overload
