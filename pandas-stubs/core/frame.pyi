...
class DataFrame:
    ...
    def itertuples(
        self, index: bool = True, name: Optional[str] = None
    ) -> Iterator[
        Tuple[Any, ...]
    ]: ...  # Don't know how to express a named tuple with a variable name/num of slots
    def max(self) -> Series: ...
    ...
    def rename(
        self,
        mapper: Union[Dict[Hashable, Hashable], Callable],
        inplace: Literal[True],
        axis: _AxisType = ...,
    ) -> None: ...
    @overload
    def rename(
        self, *, columns: Union[Dict[Hashable, Hashable], Callable], inplace: Literal[False]
    ) -> DataFrame: ...
    @overload
    def rename(
        self, *, index: Union[Dict[Hashable, Hashable], Callable], inplace: Literal[True]
    ) -> None: ...
    @overload
    # Only way to specify the "default" value of inplace while doing overloads
