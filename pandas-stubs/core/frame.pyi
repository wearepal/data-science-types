...
class DataFrame:
    ...
    @overload
    def fillna(self, value: Union[Scalar, Dict, Series, DataFrame], method: str = ..., axis: Union[str, int] = ..., inplace: Literal[True], limit: int = ..., downcast: Dict = ...) -> None: ...
    @overload
    def fillna(self, value: Union[Scalar, Dict, Series, DataFrame], method: str = ..., axis: Union[str, int] = ..., inplace: Literal[False] = ..., limit: int = ..., downcast: Dict = ...) -> DataFrame: ...
    @overload
