...
class DataFrame:
    ...
    @overload
    def __getitem__(self, idx: Union[_ListLike[_str], Index]) -> DataFrame: ...
    @overload
    ...
    @overload
    def __getitem__(self, idx: Sequence) -> DataFrame: ...
    ...
    def columns(self, cols: Union[List[_str], List[int], Index]) -> None: ...
    @property
