...
class StringMethods:
    ...
    def findall(self, sub: str, flags: int = ...) -> Series[List[str]]: ...
    def get(i: int) -> Series: ...
    def index(self, sub: str, start: int, end: int) -> Series: ...
    def join(self, sep: str) -> Series: ...
    def len(self) -> Series[int]: ...
    def ljsut(self, width: int, fillchar: str) -> Series: ...
    ...
    def translate(self, start, table: dict) -> Series: ...
    def wrap(
        self,
        width: int,
